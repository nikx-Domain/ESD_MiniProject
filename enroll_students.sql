-- Add students to courses - matching your actual schema
USE academia;

-- Note: Student table has 'name' and 'rno' columns, not first_name/last_name/roll_number

-- Add 50 sample students
INSERT IGNORE INTO student (id, name, rno, email) VALUES
-- iMTech CSE Students (1-15)
...
-- Enroll students in courses (5-10 students per course for better distribution)

-- Course 101: Programming Fundamentals
INSERT INTO student_course (student_id, course_id) VALUES
(1, 101), (2, 101), (3, 101), (4, 101), (5, 101), (6, 101), (7, 101), (8, 101);

-- Course 102: Web Technologies
INSERT INTO student_course (student_id, course_id) VALUES
(9, 102), (10, 102), (11, 102), (12, 102), (13, 102), (14, 102);

-- Course 103: Data Structures
INSERT INTO student_course (student_id, course_id) VALUES
(1, 103), (3, 103), (5, 103), (7, 103), (9, 103), (11, 103), (13, 103), (15, 103);

-- Course 104: Data Structures & Algorithms
INSERT INTO student_course (student_id, course_id) VALUES
(2, 104), (4, 104), (6, 104), (8, 104), (10, 104), (12, 104), (14, 104);

-- Course 105: Digital Electronics
INSERT INTO student_course (student_id, course_id) VALUES
(16, 105), (17, 105), (18, 105), (19, 105), (20, 105), (21, 105), (22, 105);

-- Course 106: Signals & Systems
INSERT INTO student_course (student_id, course_id) VALUES
(23, 106), (24, 106), (25, 106), (26, 106), (27, 106), (28, 106);

-- Course 107: Database Management Systems
INSERT INTO student_course (student_id, course_id) VALUES
(1, 107), (2, 107), (3, 107), (15, 107), (29, 107), (30, 107), (31, 107), (32, 107);

-- Course 108: Computer Networks
INSERT INTO student_course (student_id, course_id) VALUES
(4, 108), (5, 108), (6, 108), (33, 108), (34, 108), (35, 108);

-- Course 109: Machine Learning
INSERT INTO student_course (student_id, course_id) VALUES
(31, 109), (32, 109), (33, 109), (34, 109), (35, 109), (36, 109), (37, 109), (38, 109);

-- Course 110: Data Mining
INSERT INTO student_course (student_id, course_id) VALUES
(39, 110), (40, 110), (41, 110), (42, 110), (43, 110), (44, 110), (45, 110);

-- Course 111: Operating Systems
INSERT INTO student_course (student_id, course_id) VALUES
(1, 111), (7, 111), (8, 111), (9, 111), (10, 111), (11, 111);

-- Course 112: Software Engineering
INSERT INTO student_course (student_id, course_id) VALUES
(2, 112), (3, 112), (12, 112), (13, 112), (14, 112), (15, 112), (46, 112);

-- Course 113: Analog Circuits
INSERT INTO student_course (student_id, course_id) VALUES
(16, 113), (17, 113), (18, 113), (19, 113), (20, 113);

-- Course 114: Wireless Communication
INSERT INTO student_course (student_id, course_id) VALUES
(21, 114), (22, 114), (23, 114), (24, 114), (25, 114), (26, 114);

-- Course 115: Cloud Computing
INSERT INTO student_course (student_id, course_id) VALUES
(4, 115), (5, 115), (6, 115), (46, 115), (47, 115), (48, 115);

-- Course 116: IoT Systems
INSERT INTO student_course (student_id, course_id) VALUES
(27, 116), (28, 116), (29, 116), (30, 116);

-- Course 117: Statistical Learning
INSERT INTO student_course (student_id, course_id) VALUES
(31, 117), (32, 117), (33, 117), (49, 117), (50, 117);

-- Course 118: Advanced ML
INSERT INTO student_course (student_id, course_id) VALUES
(34, 118), (35, 118), (36, 118), (37, 118), (38, 118), (39, 118);

-- Course 119: Big Data
INSERT INTO student_course (student_id, course_id) VALUES
(40, 119), (41, 119), (42, 119), (43, 119), (44, 119);

-- Course 120: AI Ethics
INSERT INTO student_course (student_id, course_id) VALUES
...
SELECT 'Student enrollments complete! Added 50 students.' AS Status;
SELECT 
    c.c_code AS 'Course Code',
    c.name AS 'Course Name',
    COUNT(sc.student_id) AS 'Enrolled Students'
FROM course c
LEFT JOIN student_course sc ON c.id = sc.course_id
GROUP BY c.id, c.c_code, c.name
